...
- **Full product documentation** for HotelRestaurantMini-MartManagement (web app at `hotel-restaurant-minimart.firebaseapp.com`) is in the [`doc/`](doc/) folder — start at [`doc/README.md`](doc/README.md).
