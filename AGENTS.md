...
- **Full product documentation** for HotelRestaurantMini-MartManagement (web app at `hotel-restaurant-minimart.firebaseapp.com`) is in the [`doc/`](doc/) folder — browse at [https://roireuven.github.io/11/doc/](https://roireuven.github.io/11/doc/) (Docsify site) or start at [`doc/README.md`](doc/README.md).
