# HotelRestaurantMini-MartManagement — ドキュメント

**HotelRestaurantMini-MartManagement**（v2.0）の完全ドキュメント。**ホテル**、**レストラン**、**ミニマート**、**POS** 運用を統合したプロパティ管理システムです。
...
セットアップ、日常運用、管理、技術リファレンスのユーザーガイド。サイドバーでトピックを参照してください。
...
1. **はじめに** と **初回セットアップ** を読む。
2. **ユーザー役割と権限** で役割を割り当てる。
3. **設定と構成** で施設を設定する。
