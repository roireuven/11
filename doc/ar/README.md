# HotelRestaurantMini-MartManagement — التوثيق

توثيق كامل لـ **HotelRestaurantMini-MartManagement** (v2.0)، نظام إدارة متكامل لل**فندق** و**المطعم** و**ميني مارت** وعمليات **نقطة البيع (POS)**.
...
أدلة المستخدم للإعداد والعمليات اليومية والإدارة والمرجع التقني. استخدم الشريط الجانبي لتصفح المواضيع.
...
1. اقرأ **البدء** و**الإعداد لأول مرة**.
2. عيّن الأدوار عبر **أدوار المستخدم والصلاحيات**.
3. اضبط المنشأة في **الإعدادات والتكوين**.
