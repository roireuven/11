...
* **البدء**
  ...
  * [الإعداد لأول مرة](first-time-setup.md)
  * [بيانات اعتماد تجريبية](demo-credentials.md)

* **استخدام النظام**
  * [أدوار المستخدم والصلاحيات](user-roles-and-permissions.md)
  * [التنقل وواجهة المستخدم](navigation-and-ui.md)
  * [عمليات الفندق](hotel-operations.md)
  ...
  * [التقارير](reports.md)
  * [الحسابات والتدقيق](accounts-and-audit.md)

* **الإدارة**
  * [الإعدادات والتكوين](settings-and-configuration.md)
  * [النسخ الاحتياطي والاستعادة والبيانات](backup-restore-and-data.md)
  * [التوطين](localization.md)
...
* **تقني**
  ...
  * [استكشاف الأخطاء والأسئلة الشائعة](troubleshooting-faq.md)
