# HotelRestaurantMini-MartManagement — Dokumentasi

Dokumentasi lengkap untuk **HotelRestaurantMini-MartManagement** (v2.0), sistem manajemen properti all-in-one untuk **hotel**, **restoran**, **mini-mart**, dan operasi **POS**.
...
Panduan pengguna untuk penyiapan, operasi harian, administrasi, dan referensi teknis. Gunakan sidebar untuk menelusuri topik.
...
1. Baca **Memulai** dan **Penyiapan pertama kali**.
2. Tetapkan peran melalui **Peran & izin pengguna**.
3. Konfigurasi properti di **Pengaturan & konfigurasi**.
