# HotelRestaurantMini-MartManagement — Документация

Полная документация **HotelRestaurantMini-MartManagement** (v2.0) — универсальной системы управления для **отеля**, **ресторана**, **минимаркета** и **POS**.
...
Руководства пользователя по настройке, ежедневной работе, администрированию и технической справке. Используйте боковую панель для просмотра тем.
...
1. Прочитайте **Начало работы** и **Первоначальную настройку**.
2. Назначьте роли через **Роли и права пользователей**.
3. Настройте объект в **Настройках и конфигурации**.
