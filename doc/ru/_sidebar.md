...
* **Начало работы**
  ...
  * [Первоначальная настройка](first-time-setup.md)
  * [Демо-учётные данные](demo-credentials.md)

* **Использование системы**
  * [Роли и права пользователей](user-roles-and-permissions.md)
  * [Навигация и интерфейс](navigation-and-ui.md)
  * [Гостиничные операции](hotel-operations.md)
  ...
  * [Отчёты](reports.md)
  * [Учётные записи и аудит](accounts-and-audit.md)

* **Администрирование**
  * [Настройки и конфигурация](settings-and-configuration.md)
  * [Резервное копирование, восстановление и данные](backup-restore-and-data.md)
...
* **Техническое**
  ...
  * [Устранение неполадок и FAQ](troubleshooting-faq.md)
