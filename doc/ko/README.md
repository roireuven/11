# HotelRestaurantMini-MartManagement — 문서

**HotelRestaurantMini-MartManagement**(v2.0)의 전체 문서입니다. **호텔**, **레스토랑**, **미니마트**, **POS** 운영을 위한 올인원 숙박 관리 시스템입니다.
...
설정, 일상 운영, 관리 및 기술 참조를 위한 사용자 가이드입니다. 사이드바에서 주제를 찾아보세요.
...
1. **시작하기** 및 **최초 설정**을 읽으세요.
2. **사용자 역할 및 권한**으로 역할을 할당하세요.
3. **설정 및 구성**에서 시설을 구성하세요.
