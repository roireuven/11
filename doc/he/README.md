# HotelRestaurantMini-MartManagement — תיעוד

תיעוד מלא עבור **HotelRestaurantMini-MartManagement** (v2.0), מערכת ניהול נכסים מקיפה ל**מלון**, **מסעדה**, **מיני-מרקט** ופעילות **קופה**.
...
מדריכי משתמש להגדרה, תפעול יומי, ניהול וסימוכין טכני. השתמשו בסרגל הצד לעיון בנושאים.
...
1. קראו **התחלה** ו**הגדרה ראשונית**.
2. הקצו תפקידים ב**תפקידי משתמש והרשאות**.
3. הגדירו את הנכס ב**הגדרות ותצורה**.
