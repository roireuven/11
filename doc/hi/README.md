# HotelRestaurantMini-MartManagement — दस्तावेज़

**HotelRestaurantMini-MartManagement** (v2.0) का पूर्ण दस्तावेज़ — **होटल**, **रेस्तरां**, **मिनी-मार्ट** और **POS** संचालन के लिए ऑल-इन-वन प्रॉपर्टी प्रबंधन प्रणाली।
...
सेटअप, दैनिक संचालन, प्रशासन और तकनीकी संदर्भ के लिए उपयोगकर्ता गाइड। विषयों को देखने के लिए साइडबार का उपयोग करें।
...
1. **शुरुआत** और **पहली बार सेटअप** पढ़ें।
2. **उपयोगकर्ता भूमिकाएँ और अनुमतियाँ** से भूमिकाएँ निर्दिष्ट करें।
3. **सेटिंग्स और कॉन्फ़िगरेशन** में प्रॉपर्टी कॉन्फ़िगर करें।
