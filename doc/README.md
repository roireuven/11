...
> **Browse online:** [https://roireuven.github.io/11/doc/](https://roireuven.github.io/11/doc/) (searchable docs site)

## Live application

| Platform | URL |
|----------|-----|
| **Web (Firebase Hosting)** | [https://hotel-restaurant-minimart.firebaseapp.com/](https://hotel-restaurant-minimart.firebaseapp.com/) |
| **Alternate domain** | [https://hotel-restaurant-minimart.web.app/](https://hotel-restaurant-minimart.web.app/) |
...
| [Navigation & UI](navigation-and-ui.md) | Sidebar, mobile bottom nav, dark mode, languages |
...
| [Deployment](deployment.md) | Firebase Hosting and Android |
...
- **App version:** v2.0 (First-Time Setup flow)
- **Setup marker:** `2026-04-30-fresh-5` (embedded in production build)
- **Documentation generated from:** production web app at `hotel-restaurant-minimart.firebaseapp.com`
...
4. Train staff using the module guides (hotel, restaurant, mini-mart).
