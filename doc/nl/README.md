# HotelRestaurantMini-MartManagement — Documentatie

Volledige documentatie voor **HotelRestaurantMini-MartManagement** (v2.0), een alles-in-één vastgoedbeheersysteem voor **hotel**, **restaurant**, **minimarkt** en **POS**-activiteiten.
...
Gebruikersgidsen voor setup, dagelijkse operaties, administratie en technische referentie. Gebruik de zijbalk om onderwerpen te doorbladeren.
...
1. Lees **Aan de slag** en **Eerste setup**.
2. Wijs rollen toe via **Gebruikersrollen & rechten**.
3. Configureer het pand in **Instellingen & configuratie**.
