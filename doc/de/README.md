# HotelRestaurantMini-MartManagement — Dokumentation

Vollständige Dokumentation für **HotelRestaurantMini-MartManagement** (v2.0), ein All-in-One-Verwaltungssystem für **Hotel**, **Restaurant**, **Minimarkt** und **Kasse**.
...
Benutzerhandbücher für Einrichtung, täglichen Betrieb, Administration und technische Referenz. Nutzen Sie die Seitenleiste zum Durchsuchen.
...
1. Lesen Sie **Erste Schritte** und **Ersteinrichtung**.
2. Weisen Sie Rollen über **Benutzerrollen & Berechtigungen** zu.
3. Konfigurieren Sie die Immobilie unter **Einstellungen & Konfiguration**.
