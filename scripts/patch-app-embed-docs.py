...
def patch(content: str) -> str:
    ...
    # i18n: add nav.documentation to embedded en locale block (first occurrence in nav section)
    nav_doc = '"documentation": "Documentation",'
    if '"documentation":' not in content and '"settings": "Settings"' in content:
        content = content.replace(
            '"settings": "Settings"',
...
def main() -> int:
    ...
    print(f"Patched {index} — documentation embedded in app sidebar")
    return 0
